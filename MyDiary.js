...
import { Container, DeckSwiper, Card, Header, CardItem, Thumbnail, Item, Left, Body, Right, Title, Input, Icon, Content, Footer, FooterTab, Button, Badge } from 'native-base';
...
export default class MyDiary extends Component {
  ...
  render() {
    return (
      ...
      <Button iconLeft onPress={() => this._deckSwiper._root.swipeLeft()} style={styles.button}>
         <Icon style={{marginLeft:10}} name="arrow-back" />
         <Text style={{marginRight:10}}>Swipe Left</Text>
       </Button>
       <Button iconRight onPress={() => this._deckSwiper._root.swipeRight()} style={styles.button}>
