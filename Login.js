  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <ImageBackground source={require('./run.jpg')} style={styles.backgroundImage}>
        <View style={styles.content}>
              <Text style={styles.logo1}>New Tempo</Text>

                <TextInput underlineColorIos='transparent' style={styles.input} text={this.state.email}
                onTextChange={email => this.setState({email})}
                        placeholder='username' value={this.state.email}
                        onChangeText={email => this.setState({ email })}>
                </TextInput>

                <TextInput secureTextEntry={true} underlineColorIos='transparent' style={styles.input} text={this.state.password}
                ...
                <Text style={styles.logo2}>You will be reminded of why you run and why you love it so much.</Text>
           </View>
          </ImageBackground>
      </View>
    );
